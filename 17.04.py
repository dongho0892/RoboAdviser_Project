...
class Kiwoom(QAxWidget):
    ...
    def comm_rq_data(self, rq_name, tr_code, prev_next, screen_no):
        ...
        print(444)
################ 추가 - getcommdata  :  기존 것 말고 바뀜

    def _get_comm_data(self, tr_code, record_name, index, item_name):
        ret = self.dynamicCall('GetCommData(QString, QString, int, QString)', tr_code, record_name, index, item_name)
        return ret.strip()
...
if __name__ == "__main__":
    ...
    con = sqlite3.connect("C:/Users/No.1/stock3.db")
